...
export class LoginComponent implements OnInit {
  ...
  constructor(public loginService : LoginService, private router: Router, private fb: FormBuilder, private messageService: MessageService) {}
  ...
  onSubmit(): void {
    ...
    console.log(this.loginService.getUser().toLowerCase());
